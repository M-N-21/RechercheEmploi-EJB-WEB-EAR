...
<body>
  ...
  <header id="header" class="fixed-top header-transparent">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <h1 class="logo"><a href="index.html">YakarLiguey</a></h1>
  ...
  <section id="hero" class="d-flex align-items-center justify-content-center">
    <div class="container position-relative">
      <h1>Bienvenue dans la plateforme YakarLiguey</h1>
      <h2>Trouvez le boulot de vos reves ici et nulle part ailleurs</h2>
      <a href="CV?page=liste" class="btn-get-started scrollto">Creer son CV</a>
    </div>
  </section><!-- End Hero -->

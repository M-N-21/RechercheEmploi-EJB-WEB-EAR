    ...
    <section class="inner-page">
      <div class="container">
      	<table class="table table-stripped">
      		...
      		<c:if test="${listecv != null }">
      			<c:forEach items="${listecv}" var="c">
      				<tr>
      					<td>${c.titre }</td>
      					<td>${c.profil }</td>
      					<td>${c.experience }</td>
      					...
      					<td>${c.competence }</td>
      					<td>${c.divers }</td>
      					<td><a href="CV?page=editer&id=${c.id }" class="btn btn-outline-warning">Editer</a></td>
      					<td><a href="CV?page=delete&id=${c.id }" class="btn btn-outline-danger">Supprimer</a></td>
      					<td><a href="CV?page=imprimer&id=${c.id }" class="btn btn-outline-primary">Imprimer</a></td>
      				</tr>
      			</c:forEach>
      		</c:if>
      	</table>
